...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        chirana_help: "Read FILE(s) content and print it to the standard output (screen).",
        system_help: "Print the user name associated with the current effective user ID and more info.",
        date_help: "Print the system date and time.",
        help_help: "Print this menu.",
        clear_help: "Clear the terminal screen.",
        reboot_help: "Reboot the website.",
        welcome: "Welcome to chiranadevvan.tk! :)\nYou Want To Visit This Web Site Please Type help Command.",
...
var files = (function () {
    ...
    Singleton.defaultOptions = {
        "About": "I Am Chirana Devvan.\nI Am 18 Years Old.\nThis website was made using only pure JavaScript with no extra libraries.",
		"Projecct": "Web Developing.\nWeb Designing.\nLogo Designing.\nEditing.\nArduino Circuite Designing.",
		"Skills": "HTML 100%\nCSS 50%\nPYTHON 80%\nSQL 50%\nPHP 50%",
        "Contact": "chiranadevvan@gmail.com",
		"chiranadevvan": "https://chiranadevvan.cf/"
...
var main = (function () {
    ...
    var cmds = {
        ...
        CHIRANA: { value: "chirana", help: configs.getInstance().chirana_help },
        SYSTEM: { value: "system", help: configs.getInstance().system_help },
    ...
    Terminal.prototype.prepareSideNav = function () {
        ...
        for (var file in files.getInstance()) {
            ...
            element.onclick = function (file, event) {
                this.handleSidenav(event);
                this.cmdLine.value = "chirana " + file + " ";
                this.handleCmd();
            }.bind(this, file);
    ...
    Terminal.prototype.handleCmd = function () {
        ...
        switch (cmdComponents[0]) {
            case cmds.CHIRANA.value:
                this.chirana(cmdComponents);
                break;
            case cmds.LS.value:
                this.ls();
                break;
            case cmds.SYSTEM.value:
                this.system();
                break;
    ...
    Terminal.prototype.chirana = function (cmdComponents) {
        var result;
        if (cmdComponents.length <= 1) {
            result = configs.getInstance().usage + ": " + cmds.CHIRANA.value + " <" + configs.getInstance().file + ">";
    ...
    Terminal.prototype.system = function (cmdComponents) {
